...
> = {
  ...
  "POST /packages": createConversationPackageController.handle,
  "PUT /packages/{id}": updateConversationPackageController.handle,
  "GET /packages": listConversationPackagesController.handle,
  "DELETE /packages/{id}": deleteConversationPackageController.handle,
